...
| hreflang + canonical（en/zh/es 互为多语种，避免重复内容） | 🧑‍💻 | 🟡 sitemap里已带hreflang；页面<head>的hreflang+canonical在第3步 |
...
| **第2步** | 三语 metadata + OG meta（首页/比赛页/排行榜/预测页，英文长尾标题） | ⬜ |
| **第3步** | 页面 `<head>` 的 hreflang + canonical（多语种声明、防重复） | ⬜ |
